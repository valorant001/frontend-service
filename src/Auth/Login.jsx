    ...
    <div className="min-h-screen w-full bg-[#050506] grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="flex items-center justify-center px-6 py-20 text-gray-200">
        ...
        >
          ...
          <form className="space-y-6" onSubmit={navigatetoDashboard}>
            <div>
              <label className="text-sm text-gray-400">Email</label>
              <input
                type="email"
                className="w-full mt-2 p-3 rounded-xl bg-[#111] border border-white/10 text-white
            ...
            <button
              type="submit"
              className="w-full py-3 bg-linear-to-r from-blue-600 to-indigo-600 text-white rounded-xl
