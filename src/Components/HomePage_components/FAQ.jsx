const FAQ = () => {
  return (
        ...
        <div className="max-w-4xl mx-auto space-y-6 text-gray-400">
          <div>
            <div className="font-semibold">How does AdsReacher publish my ads?</div>
          ...
          <div>
            ...
            <div>No — you can run ads through AdsReacher manager account or connect your own account.</div>
          </div>
